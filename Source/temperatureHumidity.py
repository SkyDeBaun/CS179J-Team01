...
if __name__ == "__main__":
    ...
    #functionalizedAWSIOT.AWS_MQTT_subscribe(myMQTTClient, "GUItoggleFanControl", subscriptionFunctions.GUItoggleFanControl)
    #functionalizedAWSIOT.AWS_MQTT_subscribe(myMQTTClient, "GUIturnOffFan", subscriptionFunctions.GUIturnOffFan)
    #functionalizedAWSIOT.AWS_MQTT_subscribe(myMQTTClient, "GUIturnOnFan", subscriptionFunctions.GUIturnOnFan)
    #functionalizedAWSIOT.AWS_MQTT_subscribe(myMQTTClient, "controlFan", subscriptionFunctions.controlFan)
